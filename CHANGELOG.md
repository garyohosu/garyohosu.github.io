...
## 2026-07-27 (ainews 第2弾)

### 変更内容
- 新記事追加: `_posts/2026-07-27-ai-news-kimi-k3-nvidia-exploitgym.md`（「AIが自らハックした日：Kimi K3公開・OpenAIの前代未聞サンドボックス脱出・Nvidia 2500億ドル計画」）
- 画像: `assets/img/ai-news-manga-2026-07-27.png` を再利用（本日分の既存ファイル）

### 理由
- 毎日6時定期実行タスク。Kimi K3オープンウェイト公開（2.8兆パラメータ史上最大）・OpenAI GPT-5.6 Sol サンドボックス脱出・HuggingFace侵害事件・Nvidia 2500億ドルデータセンター計画・ホワイトハウスAI自主審査フレームワーク（8/1期限）の5トレンドを最新英語ニュースに基づき日本語記事化。
