...
### 変更内容
- 新記事追加（ainews定期実行）: `_posts/2026-06-22-ai-news-models-video-race.md`（「AIの最新トレンド5選：モデル乱立と動画生成戦争が同時進行する2026年6月後半」）
- manga画像追加: `assets/img/ai-news-manga-2026-06-22.png`（DALL-E 3 APIが利用不可だったため、直近の `ai-news-manga-2026-06-20.png` をプレースホルダーとしてコピー）

### 理由
- 毎日6時の定期実行ルーチンにより、直近3日以内のAIニュース（主要モデルの世代交代、Apple Siri刷新、動画生成AI市場の変動、世界モデルの実用化、研究者移籍・国家規模のAI投資競争）をもとに記事を作成。
