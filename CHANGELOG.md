...
### 変更内容
- `.github/workflows/daily-ainews.yml` を追加: 毎日6時（JST）にAIニュース記事を自動生成・push・Pages更新するワークフロー
- `ainews.md` を更新: サンプル記事からClaude Code向け実行指示書に刷新（検索手順・記事構成・品質チェック・スタイルガイドを明記）

### 理由
- AIニュース記事の生成・公開を毎日自動化するため
