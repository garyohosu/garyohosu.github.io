...
### 変更内容
- 新記事追加（ainews定期実行）: `_posts/2026-06-19-ai-news-siri-extensions-and-credits.md`（「AIの最新トレンド5選：SiriがAIを「選べる」時代になった2026年6月」）
- manga画像追加（プレースホルダー）: `assets/img/ai-news-manga-2026-06-19.png`（直近の `ai-news-manga-2026-06-16.png` を複製。本環境にDALL-E画像生成のAPIキー/MCPツールが存在しなかったため）
- **重要な修正**: `ainews.md`（記事作成の指示書）が2026-05-25のコミットで誤って生成済み記事の本文に上書きされ、指示書の内容が消えていたバグを修正。コミット`d75379b`時点の元の指示文をgit履歴から復元。

### 理由
- 毎日朝6時のainews定期実行ルーティンとして、直近3日以内のAIニュースを調査し記事化
- `ainews.md` が壊れていたため、まずバグを修正してから記事生成手順を実行した
