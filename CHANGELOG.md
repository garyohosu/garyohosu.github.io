...
## 2026-07-07 (ainews定期実行)

### 変更内容
- 新記事追加: `_posts/2026-07-07-ai-news-sonnet5-un-governance.md`（AIニュース: Claude Sonnet 5・国連AIガバナンス対話・イリノイ州AI安全法ほか）
- アイキャッチ画像追加: `assets/img/ai-news-manga-2026-07-07.png`（プレースホルダー: OPENAI_API_KEY未設定のため2026-07-05画像を流用）

### 理由
- 毎日6時スケジュール実行によるainews定期更新。2026年7月第1週の主要AIニュース（Sonnet 5リリース・Gemini 3.5 Pro遅延・GPT-5.6・国連AIガバナンス・イリノイ州AI安全法・中国AI急拡大）を記事化。
